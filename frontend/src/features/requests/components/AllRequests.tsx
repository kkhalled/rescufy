...
export default function AllRequests() {
  ...
  return (
    <div className="space-y-5">
      <div className="rounded-2xl border border-border bg-bg-card px-4 py-3 shadow-card">
      ...
      <div className="grid grid-cols-1 gap-5 xl:grid-cols-[minmax(0,7fr)_minmax(0,3fr)]">
        <section className="rounded-2xl border border-border bg-background-second/50 p-4 shadow-card">
          <header className="mb-3 flex items-center justify-between border-b border-border pb-3">
            ...
            <div className="flex flex-wrap items-center justify-end gap-2">
              <span className="rounded-full border border-border bg-surface-muted/45 px-2.5 py-1 text-[11px] text-muted">
              ...
              <div className="inline-flex items-center gap-2 rounded-full border border-border bg-surface-muted/45 px-3 py-1 text-xs text-muted">
      ...
      {!isLoading && requests.length === 0 ? (
        <div className="rounded-xl border border-dashed border-border bg-surface-muted/30 px-4 py-6 text-center">
