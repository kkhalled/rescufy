...
type RequestStatus = "pending" | "assigned" | "en-route" | "completed";
...
export function RequestRow({
  ...
  return (
    <div className={`relative flex flex-col md:flex-row md:items-center gap-3 md:gap-6 px-4 md:px-6 py-3 md:py-4 bg-card border-b border-border`}>
